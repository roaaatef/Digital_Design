...
# Created by write_sdc on Sun Sep 7 14:45:15 2025
...
group_path -name INOUT  -from [list [get_ports CLK] [get_ports RST] [get_ports DATA_VALID] [get_ports PAR_EN] [get_ports PAR_TYP] [get_ports {P_DATA[7]}] [get_ports {P_DATA[6]}] [get_ports {P_DATA[5]}] [get_ports {P_DATA[4]}] [get_ports {P_DATA[3]}] [get_ports {P_DATA[2]}] [get_ports {P_DATA[1]}] [get_ports {P_DATA[0]}]]  -to [list [get_ports TX_OUT] [get_ports busy]]
group_path -name INREG  -from [list [get_ports CLK] [get_ports RST] [get_ports DATA_VALID] [get_ports PAR_EN] [get_ports PAR_TYP] [get_ports {P_DATA[7]}] [get_ports {P_DATA[6]}] [get_ports {P_DATA[5]}] [get_ports {P_DATA[4]}] [get_ports {P_DATA[3]}] [get_ports {P_DATA[2]}] [get_ports {P_DATA[1]}] [get_ports {P_DATA[0]}]]
