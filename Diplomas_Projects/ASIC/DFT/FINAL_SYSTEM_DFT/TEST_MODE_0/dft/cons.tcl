...
#1. Master Clocks
#REF CLK
create_clock -name REF_CLK -period 20 -waveform "0 [expr 20/2]" [get_ports REF_CLK]
...
#UART CLK
create_clock -name UART_CLK -period 271.267361 -waveform "0 [expr 271.267361/2]" [get_ports UART_CLK]
...
create_generated_clock -master_clock REF_CLK -source [get_ports REF_CLK] \
                       -name "ALU_CLK" [get_ports clk_gate/GATED_CLK] \
                       -divide_by 1
set_clock_uncertainty -setup 0.2 [get_clocks ALU_CLK]
set_clock_uncertainty -hold 0.1  [get_clocks ALU_CLK]				   
#scan_clk
create_clock -name scan_clk -period 100 -waveform "0 [expr 100/2]" [get_ports scan_clk]
set_clock_uncertainty -setup 0.2 [get_clocks scan_clk]
set_clock_uncertainty -hold 0.1  [get_clocks scan_clk]
set_clock_transition -rise 0.05  [get_clock scan_clk]
set_clock_transition -fall 0.05  [get_clocks scan_clk]
...
####################################################################################
           ...
           #########################################################
####################################################################################
set_input_delay 54.2534722 -clock UART_CLK [get_port UART_RX_IN]
...
set_output_delay 1736.299512 -clock TX_CLK [get_port UART_TX_O]
set_output_delay 54.2534722 -clock UART_CLK [get_port parity_error]
set_output_delay 54.2534722 -clock UART_CLK [get_port framing_error]
