...
HD_PWD='D:/KareemWaseem/Questa_sem/Assignment_5/ass_5_4/ass_5_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spr.tcl
